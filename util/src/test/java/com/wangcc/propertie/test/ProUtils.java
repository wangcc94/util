 ...
 */
package com.wangcc.propertie.test;
...
public class ProUtils {
	private static Logger log = LoggerFactory.getLogger(ProUtils.class);

	private static ProUtils systemConfiguration = new ProUtils();
